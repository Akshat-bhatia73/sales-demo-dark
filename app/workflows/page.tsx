      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {pipelines.map((pipeline) => {
            ...
            return (
              <div key={pipeline.id} className="border border-neutral-800 bg-gradient-to-br from-neutral-800/60 via-neutral-800/65 to-neutral-800/70 hover:border-neutral-700 rounded-lg p-4 space-y-4 hover:shadow-md transition-shadow">
                <h3 className="font-medium text-lg border-b border-neutral-700 pb-4">{pipeline.name}</h3>
                ...
                <div className="space-y-3">
                  {nodeDetails.inputs && nodeDetails.inputs.length > 0 && (
                    <div className="space-y-1">
                      ...
                      <div className="ml-6 text-xs text-neutral-800-500">
                        {nodeDetails.inputs.map((input, i) => (
                          <span key={i} className="inline-block bg-neutral-800 rounded px-2 py-1 mr-1 mb-1 capitalize">
                            {input}
                          </span>
                        ))}
                      </div>

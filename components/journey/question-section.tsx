  ...
  return (
    <div className="relative w-full mb-6">
      <div className="relative group">
        ...
        <Command className="relative rounded-xl border border-neutral-800/50 bg-slate-900/95 backdrop-blur-xl shadow-2xl">
          <div className="flex items-center px-4 py-3">
            <Search className="w-4 h-4 mr-2 text-neutral-200" />
            <input
              placeholder="Ask anything about this journey analysis..."
              className="flex-1 bg-transparent outline-none placeholder:text-neutral-200 text-slate-100"
      ...
      {isFocused && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-slate-900/95 backdrop-blur-xl rounded-xl border border-neutral-800/50 p-2 shadow-2xl z-50">

...
export function ExecutionConfirmation({ isOpen, onClose, onConfirm, onModify }: ExecutionConfirmationProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[600px] modal-gradient border-neutral-800 backdrop-blur-xl">
        <DialogHeader>
        ...
        <div className="space-y-6 mt-4">
          <div className="space-y-4">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-neutral-800">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              {["LinkedIn Campaign Manager", "Google Ads", "Salesforce"].map((tool) => (
                <div key={tool} className="flex items-center gap-2 p-2 rounded-lg bg-neutral-800">

...
export function ExecutionState({ onExecute }: ExecutionStateProps) {
  ...
  return (
    <>
      <div className="p-6 rounded-lg bg-neutral-800 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-medium">Ready to Execute</h3>
            <p className="text-sm text-neutral-200 mt-1">All systems connected and ready</p>
          </div>
        ...
        <Button
          className="w-full bg-green-500 hover:bg-blue-600 h-12 text-base font-medium"

...
export function TeamPanel() {
  ...
  return (
    <div className={cn(
      ...
      <Card className="w-80 gradient-backgroundbackdrop-blur-xl">
        <Button
          variant="ghost"
          size="sm"
          className="w-full flex items-center justify-between p-2 hover:bg-neutral-800"
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-neutral-200">Actions need approval</span>
                <span>{pendingItems.actions}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-200">Saved insights this week</span>
                <span>{pendingItems.insights}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-200">New comments</span>

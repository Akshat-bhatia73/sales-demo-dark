...
export function SkillConfigPanel({ skill, onConfigChange }: SkillConfigPanelProps) {
          ...
          <Card className="bg-neutral-800/50 border-neutral-800 p-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  <Slider
                    ...
                    onValueChange={([value]) => handleConfigUpdate({ threshold: value / 100 })}
                    min={0}
                    max={100}
                    step={1}
                    className="flex-1"
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  <Slider
                    ...
                    onValueChange={([value]) => handleConfigUpdate({ signalStrength: value / 100 })}
                    min={0}
                    max={100}
                    step={1}
                    className="flex-1"
              ...
              <div className="flex items-center justify-between">
                <label className="text-sm text-neutral-300">Auto-tuning</label>
                <Switch
                  checked={config.autoTuning}
                  onCheckedChange={(checked) => handleConfigUpdate({ autoTuning: checked })}
                />
              </div>
            </div>
          </Card>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleConfigUpdate({ customRules: e.target.value })}
              ...
              <div className="space-y-2">
                <label className="text-sm text-neutral-300">Model Version</label>
                <Input
                  value={config.modelVersion || ""}
                  onChange={(e) => handleConfigUpdate({ modelVersion: e.target.value })}
        ...
        <TabsContent value="test" className="mt-4 space-y-4">
          <Card className="bg-neutral-800/50 border-neutral-800 p-4">
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full bg-green-500 hover:bg-blue-600">
                Run Test
              </Button>

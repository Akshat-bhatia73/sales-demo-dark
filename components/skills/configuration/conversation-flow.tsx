                ...
                <div className="flex flex-wrap gap-2">
                  {["Enterprise signals", "Security focus", "Technical evaluation"].map((suggestion) => (
                    <Badge
                      key={suggestion}
                      variant="outline"
                      className="bg-slate-800/50 cursor-pointer hover:bg-neutral-800 hover:border-neutral-700"
                  ...
                  <Card
                    ...
                    className={`
                      ...
                      ${config.examples.includes(example)
                        ? 'bg-green-500/10 border-blue-500/50'
                        : 'bg-slate-900/50 border-neutral-800 hover:border-slate-600'}
                    `}
                    onClick={() => {
          ...
          >
            <Card className="bg-neutral-800/50 border-neutral-800 p-6">
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-slate-900/50 border-neutral-800 p-4">

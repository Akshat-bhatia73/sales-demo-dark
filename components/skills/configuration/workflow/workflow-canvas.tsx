...
import { Position, snapToGrid } from "@/lib/utlis/workflow";
...
export function WorkflowCanvas({ 
  ...
  return (
    <Card className="flex-1 gradient-background p-6 overflow-hidden">
      <div className="relative h-full" onClick={() => onNodeSelect(null)}>
        ...
        <motion.button 
          className="absolute bottom-4 right-4 p-2 rounded-full bg-green-500 hover:bg-green-400 text-neutral-900 transition-colors"
          onClick={addNewNode}

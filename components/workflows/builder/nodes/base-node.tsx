...
export function BaseNode({
  ...
  return (
    <Card
      className={`w-[280px] ${
        isSelected ? 'bg-neutral-800 shadow-lg border-green-400 border-2' : 'gradient-background'
      } transition-all`}
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between space-y-0 p-3 border-b border-neutral-700">
        ...
        <div className="flex items-center gap-1">
          <Button
            variant="ghost"
            size="icon"
            className="h-6 w-6 bg-neutral-800"
            onClick={(e) => {
              e.stopPropagation();
              onDelete(id);
            }}

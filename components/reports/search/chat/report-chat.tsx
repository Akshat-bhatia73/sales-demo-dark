...
export function ReportChat({ reportType }: { reportType: string }) {
  ...
  if (!showChat) {
    return (
      <Button
        ...
        className="absolute top-4 right-4 text-neutral-300 hover:text-slate-100"
      >
  ...
  return (
    <motion.div
      ...
      className="absolute top-0 right-0 w-[350px] h-full border-l border-neutral-800 bg-slate-900/95"
    >
                ...
                <motion.div
                  ...
                  className={`p-3 rounded-lg text-sm ${
                    msg.type === "agent" 
                      ...
                      : "bg-green-500/10 text-slate-100 ml-4"
                  }`}
                >
              ...
              >
                ...
                {Object.keys(sentimentResponses).map((question) => (
                  <motion.button
                    ...
                    className="w-full text-left p-2 text-sm text-neutral-300 hover:bg-neutral-800 hover:border-neutral-700/50 rounded-lg transition-colors"

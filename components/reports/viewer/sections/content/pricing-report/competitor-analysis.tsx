...
export function CompetitorAnalysis() {
  return (
    <section className="space-y-6">
      <h2 className="text-2xl font-semibold text-slate-100">Competitor Pricing Analysis</h2>
      
      <div className="grid gap-6">
        {Object.entries(competitors).map(([key, competitor]) => (
          <Card key={key} className="gradient-background p-6">
            <h3 className="text-lg font-medium text-slate-100 mb-4">{competitor.name} Changes</h3>
            
            <div className="grid grid-cols-2 gap-8">
              <div>
                <h4 className="text-sm font-medium text-neutral-300 mb-3">Core Changes</h4>
              ...
              <div>
                <h4 className="text-sm font-medium text-neutral-300 mb-3">Package Details</h4>

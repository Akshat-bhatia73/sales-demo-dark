...
export function FeatureAnalysis() {
  return (
    <section className="space-y-6">
      <h2 className="text-2xl font-semibold text-slate-100">Feature Satisfaction Analysis</h2>
      
      <div className="grid grid-cols-2 gap-6">
        <Card className="gradient-background p-6">
          <h3 className="text-lg font-medium text-slate-100 mb-4">Strongest Features</h3>
            ...
            {features.strongest.map((feature) => (
              <div key={feature.name} className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-green-400 font-semibold">{feature.score}</div>
                </div>
        ...
        <Card className="gradient-background p-6">
          <h3 className="text-lg font-medium text-slate-100 mb-4">Areas for Improvement</h3>
          <div className="space-y-6">
            {features.improvement.map((feature) => (
              <div key={feature.name} className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="font-medium text-slate-100">{feature.name}</div>
                  <div className="text-red-400 font-semibold">{feature.score}</div>
                </div>
